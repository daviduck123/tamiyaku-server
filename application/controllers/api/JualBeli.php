        ...
        try {
            ...
            if(!empty($_FILES['file']['name'])){
                if($this->upload->do_upload('file'))
                {
                    ...
                    $config2['new_image'] = './assets/images/jualbeli/'.$id_user.'/';
                    ...
                    if (!$this->image_lib->resize())
                    {
                        ...
                        $result = $this->JualBeli_Model->insert_jualBeli($nama, $harga, $path, $deskripsi, $id_user, $id_kota, $id_kelas, $id_kategori);
                        if(count($result) > 0){
                            $this->set_response([
                                'status' => TRUE,
                 ...
                 $result = $this->JualBeli_Model->insert_jualBeli($nama, $harga, NULL, $deskripsi, $id_user, $id_kota, $id_kelas, $id_kategori);
                    if(count($result) > 0){
                        $this->set_response([
                            'status' => TRUE,
                            'message' => 'Successfully Create Jual Beli'
